...
return {
  ...
  h.bind({ mod = mod, key = "D", description = "app launcher", dispatcher = "exec", arg = "pkill rofi || true && rofi -show drun -modi drun,filebrowser,run,window" }),
  h.bind({ mod = mod, key = "B", description = "open default browser", dispatcher = "exec", arg = 'xdg-open "https://"' }),
  h.bind({ mod = mod, key = "A", description = "desktop overview", dispatcher = "exec", arg = "$scriptsDir/OverviewToggle.sh" }),
  ...
  h.bind({ mod = mod, key = "T", description = "Global theme switcher using Wallust", dispatcher = "exec", arg = "$scriptsDir/ThemeChanger.sh" }),
  h.bind({ mod = mod, key = "W", description = "select wallpaper", dispatcher = "exec", arg = "$UserScripts/WallpaperSelect.sh" }),
  h.bind({ mod = mod .. " SHIFT", key = "W", description = "wallpaper effects", dispatcher = "exec", arg = "$UserScripts/WallpaperEffects.sh" }),
  h.bind({ mod = "CTRL ALT", key = "W", description = "random wallpaper", dispatcher = "exec", arg = "$UserScripts/WallpaperRandom.sh" }),
  ...
  h.bind({ mod = mod .. " SHIFT", key = "Q", description = "Terminate active process", dispatcher = "exec", arg = "$scriptsDir/KillActiveProcess.sh" }),

  h.blank(),
  h.comment("System"),
  h.bind({ mod = "CTRL ALT", key = "Delete", description = "exit Hyprland", dispatcher = "exec", arg = "hyprctl dispatch exit 0" }),
  h.bind({ mod = "CTRL ALT", key = "L", description = "lock screen", dispatcher = "exec", arg = "$scriptsDir/LockScreen.sh" }),
  h.bind({ mod = "CTRL ALT", key = "P", description = "powermenu", dispatcher = "exec", arg = "$scriptsDir/Wlogout.sh" }),
  ...
  h.bind({ mod = mod .. " SHIFT", key = "tab", description = "previous workspace", dispatcher = "workspace", arg = "m-1" }),
  ...
  h.blank(),
  h.comment("Mouse"),
  h.bind({ bind_type = "bindmd", mod = mod, key = "mouse:272", description = "move window", dispatcher = "movewindow" }),
  h.bind({ bind_type = "bindmd", mod = mod, key = "mouse:273", description = "resize window", dispatcher = "resizewindow" }),
}
